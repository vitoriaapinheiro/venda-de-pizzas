...
//eventos
btnVendas.addEventListener('click', venda, false); //false pq n quer outra coisa além disso, dessa função
btnEstorno.addEventListener('click', estorno, false);
btnPlanilha.addEventListener('click', planilha, false);

//funções
function venda(e) //e= evento; a função vai receber um evento
{
    if(document.getElementById('mussarela').checked)
    {
        somaMussarela = somaMussarela + 1;
        vendaMussarela = vendaMussarela + 25.00; //25 é o valor da pizza
